...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'uploadAllow'   => array('image/x-ms-bmp', 'application/pdf', 'image/vnd.djvu', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/zip', 'video/mp4', 'video/x-m4v', 'audio/mp3', 'image/gif', 'image/jpeg', 'image/png', 'image/x-icon', 'text/plain'), // Mimetype `image` and `text/plain` allowed to upload
