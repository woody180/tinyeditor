...
Sometimes you might need to remove tinymce toolbar and make content editable only. Now it's possible to provide inline attribute `editor-tools="false"` to remove tinymce toolbar (tools)
